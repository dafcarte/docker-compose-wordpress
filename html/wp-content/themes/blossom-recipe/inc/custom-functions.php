...
if( ! function_exists( 'blossom_recipe_redirect_on_activation' ) ) :
/**
 * Redirect to Getting Started page on theme activation
 *
 */
function blossom_recipe_redirect_on_activation() {
    global $pagenow;

    if ( is_admin() && 'themes.php' == $pagenow && isset( $_GET['activated'] ) ) {
        wp_redirect( admin_url( "themes.php?page=blossom-recipe-getting-started" ) );
    }
}
endif;
add_action( 'admin_init', 'blossom_recipe_redirect_on_activation' );