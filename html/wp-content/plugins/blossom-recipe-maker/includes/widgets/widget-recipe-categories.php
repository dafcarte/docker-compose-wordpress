...
class Brm_Recipe_Categories extends WP_Widget {
			...
			foreach ($cats as $key => $value) 		
			{
				...
				if ( ! empty( $category ) && ! is_wp_error( $category ))
				{
					...
					if( isset($img) && is_array($img) && isset($img[0]) && $img[0]!='' )
					{
						...
						echo '</a></li>';
						$url1 = ("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 470 313' preserveAspectRatio='none'><rect width='470' height='313' fill='%23f2f2f2'></rect></svg>");
	...
	public function form( $instance ) {
		...
		<input id="brm-terms-ran" value="<?php echo $ran;?>" type="hidden">
		...
		<p>
			...
			<?php if( isset( $taxonomy ) && $taxonomy != '' )
			{
				...
				{
					?>
					<select name="<?php echo $this->get_field_name( 'categories[]' );?>" class="brm-cat-select brm-categories-select-<?php echo $ran;?>" id="brm-categories-select-<?php echo $ran;?>" multiple style="width:350px;" tabindex="4">
					  	<?php
