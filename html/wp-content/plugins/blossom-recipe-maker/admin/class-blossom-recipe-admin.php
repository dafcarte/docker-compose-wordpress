...
class Blossom_Recipe_Maker_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name.'font-awesome', plugin_dir_url( __FILE__ ) . 'js/fontawesome.js', $this->version, true );
	...
	function brm_register_recipe_post_types() {
		...
		$labels = array(
			'name'                  => _x( 'Blossom Recipes', 'Post Type General Name', 'blossom-recipe-maker' ),
	...
	function brm_create_cuisine_type_taxonomies() {
		// Add new taxonomy, make it hierarchical
				...
				$args = array(
					...
					'show_admin_column' => true,
					'show_in_nav_menus' => true,
					'rewrite'           => array( 'slug' => 'recipe-cuisine', 'hierarchical' => true ),
				);
	...
	function brm_create_cooking_method_type_taxonomies() {
		// Add new taxonomy, make it hierarchical
				...
				$args = array(
					...
					'show_admin_column' => true,
					'show_in_nav_menus' => true,
					'rewrite'           => array( 'slug' => 'recipe-cooking-method', 'hierarchical' => true ),
				);
	...
	function brm_create_recipe_tags_taxonomies() {
		// Add new taxonomy, make it hierarchical
				...
				$args = array(
					...
					'show_admin_column' => true,
					'show_in_nav_menus' => true,
					'rewrite'           => array( 'slug' => 'recipe-tag', 'hierarchical' => false ),
				);
