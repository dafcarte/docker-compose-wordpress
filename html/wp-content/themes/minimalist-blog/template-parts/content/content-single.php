		...
		<div class="pagination-single">
			<div class="pagination-nav clearfix">
				...
				<div class="previous-post-wrap">
					<div class="previous-post"><a href="<?php echo esc_url( get_permalink( get_adjacent_post( false, '', true)->ID ) ); ?>"><?php esc_html_e( 'Previous Post', 'minimalist-blog' ); ?></a></div><!-- /.previous-post -->
