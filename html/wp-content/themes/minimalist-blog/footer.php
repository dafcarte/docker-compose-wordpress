...
?>
		<footer class="footer">
			...
			<div class="footer-site-info">
				...
				<?php echo esc_html__(' | Theme by', 'minimalist-blog') ?> <a href="<?php echo esc_url('https://www.crafthemes.com/', 'minimalist-blog'); ?>"><?php echo esc_html__(' Crafthemes', 'minimalist-blog') ?></a>
				</span>
