                    ...
                    <li>
                        <?php if( has_post_thumbnail() && $show_thumbnail ){ ?>
                            <a <?php echo $target;?> href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php 
                                $brm_popular_post_size = apply_filters('brm_popular_post_size', 'recipe-maker-thumbnail-size');
                                the_post_thumbnail( $brm_popular_post_size );
                                ?>
                            </a>
                        <?php }
                        if( $show_thumbnail && !has_post_thumbnail() )
                        {
                            ...
                            ?>
                            <a <?php echo $target;?> href="<?php esc_url(get_the_permalink());?>" class="post-thumbnail">
                                <?php
                                    $obj = new Blossom_Recipe_Maker_Functions();                    
                                    $obj->brm_get_fallback_svg( $img_size );//fallback
                            echo '</a>';
                        }
                        ?>
                        <div class="entry-header">
                            <?php
                            $category_detail = get_the_terms( $post->ID, 'recipe-category' );
                            ...
                            if( $show_date  ){ ?>
                                <div class="entry-meta"> 
                                    <?php $obj = new Blossom_Recipe_Maker_Functions;
                                    $obj->brm_posted_on(); ?>
                                </div>
                            <?php
                            }
