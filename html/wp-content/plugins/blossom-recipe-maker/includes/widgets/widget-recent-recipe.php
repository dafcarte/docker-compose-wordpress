                    ...
                    <li>
                        <?php if( has_post_thumbnail() && $show_thumb ){ ?>
                            <a <?php echo $target; ?> href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php 
                                $brm_recent_post_size = apply_filters('brm_recent_post_size', 'recipe-maker-thumbnail-size');
                                the_post_thumbnail( $brm_recent_post_size );
                                ?>
                            </a>
                        <?php 
                        }
                        if( $show_thumb && !has_post_thumbnail() ){
                            ...
                            echo '<a '.$target.' href="'.esc_url(get_the_permalink()).'" class="post-thumbnail">';
